...
static umsg_msg_metadata_t msg_Iridium_iridium_state = {.name = "Iridium_iridium_state"};
...
// Iridium_iridium_state
umsg_sub_handle_t umsg_Iridium_iridium_state_subscribe(uint32_t prescaler, uint8_t length)
{
    return umsg_subscribe(&msg_Iridium_iridium_state, prescaler, sizeof(umsg_Iridium_iridium_state_t), length, 0);
}
umsg_sub_handle_t umsg_Iridium_iridium_state_subscribe_ch(uint32_t prescaler, uint8_t length, uint8_t channel)
{
    return umsg_subscribe(&msg_Iridium_iridium_state, prescaler, sizeof(umsg_Iridium_iridium_state_t), length, channel);
}
void umsg_Iridium_iridium_state_publish(umsg_Iridium_iridium_state_t* data)
{
    umsg_publish(&msg_Iridium_iridium_state, data, 0);
}
void umsg_Iridium_iridium_state_publish_ch(umsg_Iridium_iridium_state_t* data, uint8_t channel)
{
    umsg_publish(&msg_Iridium_iridium_state, data, channel);
}
uint8_t umsg_Iridium_iridium_state_receive(umsg_sub_handle_t queue, umsg_Iridium_iridium_state_t* data, uint32_t timeout)
{
    return umsg_receive(queue, data, timeout);
}
uint8_t umsg_Iridium_iridium_state_peek(umsg_Iridium_iridium_state_t* data)
{
    return umsg_peek(&msg_Iridium_iridium_state, data, sizeof(umsg_Iridium_iridium_state_t));
}
